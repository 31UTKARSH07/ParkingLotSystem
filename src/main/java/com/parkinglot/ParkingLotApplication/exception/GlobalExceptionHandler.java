...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNoSpotAvailable(NoSpotAvailableException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleParkingLotNotFound(ParkingLotNotFoundException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.NOT_FOUND.value(),
                ex.getMessage(),
                LocalDateTime.now()
